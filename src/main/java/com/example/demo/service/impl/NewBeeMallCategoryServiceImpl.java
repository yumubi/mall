...
import com.example.demo.dao.GoodsCategoryMapper;
...
public class NewBeeMallCategoryServiceImpl implements NewBeeMallCategoryService {
    ...
    @Override
    public List<GoodsCategory> selectByLevelAndParentIdsAndNumber(List<Long> parentsIds, int categoryLevel) {
        return goodsCategoryMapper.selectByLevelAndParentIdsAndNumber(parentsIds, categoryLevel, 0);
    }
}
